...
public class CustomerChatActivityTest {
    ...
    @Before
    public void setUp() {
        // Launch the CustomerChatActivity
        ActivityScenario.launch(CustomerChatActivity.class);
    }
    ...
    public void testReturnButtonClick() {
        ...
        // Check if the ClientNavbarMainActivity is displayed (assuming a unique ID exists in the next activity)
