...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            VolleySingleton.userId = getPreferences(Context.MODE_PRIVATE).getString("userId", "-1");
            VolleySingleton.userType = getPreferences(Context.MODE_PRIVATE).getString("userType", "none");
